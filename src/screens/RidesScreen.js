...
const styles = StyleSheet.create({
  ...
  stepBtn: { width: 56, height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', backgroundColor: '#1A1A1A' },
  stepText: { fontSize: 14, fontWeight: '900' },
  vehicleGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  vehicleCard: { width: '48%', padding: 20, borderRadius: 24, alignItems: 'center' },
  ...
  includesCard: { borderRadius: 24, backgroundColor: '#1A1A1A', padding: 20, gap: 16 },
  includeRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  includeText: { fontSize: 15, fontWeight: '600' },
  priceBar: { marginTop: 30, borderRadius: 30, padding: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  tripCard: { height: 280, borderRadius: 32, overflow: 'hidden', marginBottom: 20 },
